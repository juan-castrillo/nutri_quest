...
class PageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      child: new Center(
        child: new Container (
          width: lerpDouble(10.0, 20.0, viewModel.activePercent),
          height: lerpDouble(10.0, 20.0, viewModel.activePercent),
          decoration: new BoxDecoration(
            shape: BoxShape.circle,
            color: viewModel.isHollow
                ? const Color(0xFF000000).withAlpha((0x88 * viewModel.activePercent).round())
                : const Color(0xFF000000),
            border: new Border.all(
              color: viewModel.isHollow
                  ? const Color(0xFF000000).withAlpha((0x88 * (1.0 - viewModel.activePercent)).round())
                  : Colors.transparent,
              width: 3.0,
            ),
          ),
